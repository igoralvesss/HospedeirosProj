...
public class QuizResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int getCorrectAnswers = getIntent().getIntExtra("Correto", 0);
        final int getIncorrectAnswers = getIntent().getIntExtra("Incorreto",0);
        ...
        startNewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(QuizResults.this, PrincipalGameActivity.class));
                finish();
            }
        });
