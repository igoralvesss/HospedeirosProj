...
public class QuizActivity extends AppCompatActivity {
    ...
    private int currentQuestionPositions = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(QuizActivity.this, PrincipalGameActivity.class));
                finish();
            }
        });
    ...
    private void changeNextQuestion(){
        ...
        if(currentQuestionPositions < questionsLists.size()){
            ...
            option1.setText(questionsLists.get(currentQuestionPositions).getOption1());
            option2.setText(questionsLists.get(currentQuestionPositions).getOption2());
            option3.setText(questionsLists.get(currentQuestionPositions).getOption3());
            option4.setText(questionsLists.get(currentQuestionPositions).getOption4());
        } else {
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (seconds == 0){
                    ...
                    Toast.makeText(QuizActivity.this, "Tempo terminou", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(QuizActivity.this, QuizResults.class);
                    intent.putExtra("Certo", getCorrectAnswers());
                    intent.putExtra("Incorreto", getIncorrectAnswers());
                    startActivity(intent);
