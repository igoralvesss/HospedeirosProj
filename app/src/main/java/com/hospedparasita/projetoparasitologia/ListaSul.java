...
public class ListaSul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_sul);

        listView = findViewById(R.id.lista_doenca_sul);
        dao = new DoencaDAO(this);
        doencas = dao.obterTodosSul();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent it = new Intent(ListaSul.this, TabInfoActivity.class);
