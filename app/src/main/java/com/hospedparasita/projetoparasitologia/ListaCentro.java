...
public class ListaCentro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_centro);

        listView = findViewById(R.id.lista_doenca_centro);
        dao = new DoencaDAO(this);
        doencas = dao.obterTodosCentro();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent it = new Intent(ListaCentro.this, TabInfoActivity.class);
